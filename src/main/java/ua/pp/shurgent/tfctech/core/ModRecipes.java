...
{	
	...
	public static void initialise()
	{
		...
		if (TFCTech.enableIE)
			TFCTechIERecipes.registerIERecipes(craftingManager, kilnCraftingManager);
	...
	private static void registerAnvilRecipes()
	{
		...
		// Sheets
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(ModItems.aluminumIngot2x), null, "sheet", AnvilReq.COPPER, new ItemStack(ModItems.aluminumSheet, 1)));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(ModItems.electrumIngot2x), null, "sheet", AnvilReq.COPPER, new ItemStack(ModItems.electrumSheet, 1)));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(ModItems.constantanIngot2x), null, "sheet", AnvilReq.WROUGHTIRON, new ItemStack(ModItems.constantanSheet, 1)));
	...
	private static void registerKilnRecipes() {
		...
		kilnCraftingManager.addRecipe(new KilnRecipe(new ItemStack(ModItems.potteryCeramicPlate, 1, 0), 0, new ItemStack(ModItems.potteryCeramicPlate, 1, 1)));		
