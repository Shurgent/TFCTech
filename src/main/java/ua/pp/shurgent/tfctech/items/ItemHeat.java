...
public class ItemHeat {
	...
	public static void setupItemHeat() {
		...
		manager.addIndex(new HeatIndex(new ItemStack(ModItems.redAlloyDust,1), redAlloyRaw, new ItemStack(ModItems.redAlloyUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(ModItems.redAlloyMix,1), redAlloyRaw, new ItemStack(ModItems.redAlloyUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(ModItems.redAlloyNugget,1), redAlloyRaw, new ItemStack(ModItems.redAlloyUnshaped,1)));
